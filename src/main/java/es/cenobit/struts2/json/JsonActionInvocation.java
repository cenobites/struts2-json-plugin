...
public class JsonActionInvocation extends DefaultActionInvocation implements ActionInvocation {
	...
	protected String invokeAction(Object action, ActionConfig actionConfig) throws Exception {
		...
		try {
			...
			if (isAnnotatedJson(method)) {
				return saveJsonResult(actionConfig, methodResult);
			}
	...
	private boolean isAnnotatedJson(Method method) {
	...
	protected String saveJsonResult(ActionConfig actionConfig, Object methodResult) throws IOException {
		...
		try {
			...
			writer.write(gson.toJson(methodResult));
			writer.flush();
		} catch (IOException e) {
